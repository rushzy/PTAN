...
config.DATASET.NO_COMPOSITION = False
config.DATASET.NO_WORD = False
...
config.MS_LOSS = edict()
config.MS_LOSS.POS = 'bce'
config.MS_LOSS.NEG = 'ssl'
config.MS_LOSS.CONTRAST = 'simple_contrast'
